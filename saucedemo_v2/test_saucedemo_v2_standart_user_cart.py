...
def test_cart_checkout_ok(browser, auth):
...
def test_cart_checkout_not_ok(browser, auth):
    browser.get(inventory_url)
    browser.find_element(*add_item2).click()
    browser.find_element(*cart_link).click()
    assert browser.current_url == cart_url
...
def test_cart_checkout_empty(browser, auth):
    browser.get(inventory_url)
    browser.find_element(*add_item2).click()
    browser.find_element(*cart_link).click()
    assert browser.current_url == cart_url
...
def test_cart_checkout_ok_not_ok_empty1(browser, auth):
    browser.get(inventory_url)
    browser.find_element(*add_item2).click()
    browser.find_element(*cart_link).click()
    assert browser.current_url == cart_url
...
def test_cart_checkout_ok_not_ok_empty2(browser, auth):
    browser.get(inventory_url)
    browser.find_element(*add_item2).click()
    browser.find_element(*cart_link).click()
    assert browser.current_url == cart_url
    ...
    browser.find_element(*continue_link).click()
    message = browser.find_element(*checkout_empty_error)
    assert message.text == error_message_checkout2, 'OK'


def test_cart_checkout_ok_not_ok_empty3(browser, auth):
    browser.get(inventory_url)
    browser.find_element(*add_item2).click()
    browser.find_element(*cart_link).click()
    assert browser.current_url == cart_url
